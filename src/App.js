  ...
  return (
        ...
        <nav className="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            <a href="index.html" className="navbar-brand d-flex align-items-center px-4 px-lg-5">
                <h2 className="m-0 text-primary"><i className="fa fa-car me-3"></i>STORE FINDER</h2>
            </a>
                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-10 col-lg-8">
                                    ...
                                    <a href="#home" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Search A Job</a>
                                    <a href="#home" class="btn btn-secondary py-md-3 px-md-5 animated slideInRight">Find A Talent</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        {/* <!-- Back to Top --> */}
        <button className="btn btn-lg btn-primary btn-lg-circle back-to-top"><i className="bi bi-arrow-up"></i></button>
